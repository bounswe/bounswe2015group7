...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <img style="width: 300px; height: 250px"
                 src="<%out.print("http://52.59.252.52:9000/image/get/" + topStory.getMedia().get(0));%>" alt="">
            <% } %>
            <%} catch (Exception e) {%>
    ...
    <hr>
        ...
        if(recommendedStories != null && recommendedStories.getResult() != null) {
        %>
    ...
    <div class="row text-center">
        ...
        <div class="col-md-3 col-sm-6 hero-feature">
            <div class="thumbnail">
                ...
                <img style="width: 200px; height: 200px"
                     src="<%out.print("http://52.59.252.52:9000/image/get/" + popularStories.getResult().get(i).getMedia().get(0));%>"
                     alt="">
                <% } %>
                <%} catch (Exception e) {%>
                <img style="width: 200px; height: 200px" src="http://en.mladinsko.com/images/emptyMME.gif" alt="">
